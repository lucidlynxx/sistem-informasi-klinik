...
<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Ubah Data Tindakan</h1>
        ...
        <div class="card text-bg-light mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('actions.update', $action->slug) }}" method="POST" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('tindakan')
                                ...
                                placeholder="Masukkan Tindakan" value="{{ old('tindakan', $action->tindakan) }}"
                                required>
                            @error('tindakan')
                    ...
                    <input type="hidden" class="form-control" id="slug" name="slug"
                        value="{{ old('slug', $action->slug) }}" required>
                        ...
                        <div class="col-sm-10">
                            <input type="number"
                                class="form-control @error('biaya')
                                                                                                                      is-invalid
                                                                                                                  @enderror" id="biaya"
                                name="biaya" placeholder="Masukkan Biaya" value="{{ old('biaya', $action->biaya) }}"
                                required>
                            @error('biaya')
                            <div class="invalid-feedback">
                                {{ $message }}
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('keterangan')
                                ...
                                placeholder="Masukkan Keterangan" value="{{ old('keterangan', $action->keterangan) }}"
                                required>
                            @error('keterangan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            ...
                            <div class="mt-3">
                                ...
                                <a href="{{ route('actions.index') }}" class="btn btn-danger"><i
