                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-10">
                            <select class="form-select form-select-sm @error('registration_id')
                                ...
                                @if (old('registration_id', $medicalrecord->registration_id))
                                <option value="{{ $medicalrecord->registration_id }}" selected>{{
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-10">
                            <select class="form-select form-select-sm @error('medicine_id')
                                ...
                                @if (old('medicine_id', $medicalrecord->medicine_id))
                                <option value="{{ $medicalrecord->medicine_id }}" selected>{{
                                    $medicalrecord->medicine->nama_obat }}
                                </option>
                                @endif
                            </select>
                            @error('medicine_id')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('jumlah_obat')
                                ...
                                value="{{ old('jumlah_obat', $medicalrecord->jumlah_obat) }}" required>
                            @error('jumlah_obat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
